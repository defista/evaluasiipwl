...
<link href="Kegiatan-Search.css" rel="stylesheet">
</head>
<body>
<div id="container">
<div id="wb_Text3" style="position:absolute;left:19px;top:160px;width:277px;height:30px;z-index:3;">
<p style="font-size:27px;line-height:30px;font-weight:bold;color:#000000;"><span style="color:#000000;">Cari Kegiatan IPWL</span></p></div>
<div id="wb_Image1" style="position:absolute;left:11px;top:17px;width:348px;height:66px;z-index:4;">
...
<div id="wb_Form1" style="position:absolute;left:19px;top:197px;width:299px;height:123px;z-index:7;">
<form name="Form1" method="post" action="mailto:yourname@yourdomain.com" enctype="multipart/form-data" id="Form1">
<a id="Button1" href="./Laporan-Kegiatan.php" style="position:absolute;left:8px;top:93px;width:107px;height:21px;z-index:0;">View</a>
<select name="Combobox1" size="1" id="Combobox1" style="position:absolute;left:8px;top:37px;width:222px;height:28px;z-index:1;">
