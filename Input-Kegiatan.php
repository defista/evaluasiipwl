...
<head>
<meta charset="utf-8">
<title>Kegiatan Input</title>
<meta name="generator" content="WYSIWYG Web Builder 15 - http://www.wysiwygwebbuilder.com">
<link href="font-awesome.min.css" rel="stylesheet">
<link href="Test_Project.css" rel="stylesheet">
<link href="Input-Kegiatan.css" rel="stylesheet">
...
<div id="wb_Text3" style="position:absolute;left:19px;top:155px;width:358px;height:30px;z-index:2;">
<p style="font-size:27px;line-height:30px;font-weight:bold;color:#000000;"><span style="color:#000000;">Input Kegiatan Rehabilitasi</span></p></div>
...
<div id="wb_GoMenu1" style="position:absolute;left:19px;top:193px;width:231px;height:43px;z-index:4;">
<form id="GoMenu1" role="menu">
   <select id="GoMenu1_select" name="GoMenu1" onchange="OnGoMenuFormLink(this)">
      <option class="_self" value="#" selected>Pilih Kegiatan</option>
      <option class="_self" value="./kegiatan-rajal.php" role="menuitem">Rehabilitasi Jalan</option>
      <option class="_self" value="./kegiatan-ranap.php" role="menuitem">Rehabilitasi Inap</option>
      <option class="_self" value="./kegiatan-aftercare.php" role="menuitem">Aftercare</option>
   </select>
</form>
</div>
<div id="wb_ResponsiveMenu1" style="position:absolute;left:11px;top:90px;width:933px;height:63px;z-index:5;">
...
<div id="wb_LoginName1" style="position:absolute;left:606px;top:17px;width:338px;height:36px;text-align:center;z-index:6;">
...
?></span></div>
<div id="wb_Image9" style="position:absolute;left:429px;top:26px;width:55px;height:48px;z-index:7;">
<img src="images/Picture4 (1).png" id="Image9" alt=""></div>
<div id="wb_Image8" style="position:absolute;left:369px;top:26px;width:60px;height:48px;z-index:8;">
<img src="images/Kemensos.png" id="Image8" alt=""></div>
<div id="wb_FontAwesomeIcon1" style="position:absolute;left:537px;top:26px;width:69px;height:48px;text-align:center;z-index:9;">
