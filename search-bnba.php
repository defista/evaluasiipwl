...
<link href="search-bnba.css" rel="stylesheet">
</head>
<body>
<div id="container">
...
<div id="wb_Text3" style="position:absolute;left:19px;top:163px;width:292px;height:24px;z-index:7;">
<p style="font-size:21px;line-height:24.5px;font-weight:bold;color:#000000;"><span style="color:#000000;">SEARCH BNBA PPKS KPN</span></p></div>
<div id="wb_Logout1" style="position:absolute;left:848px;top:59px;width:94px;height:22px;text-align:center;z-index:8;">
<form name="logoutform" method="post" action="<?php echo basename(__FILE__); ?>" id="logoutform">
<input type="hidden" name="form_name" value="logoutform">
<input type="submit" name="logout" value="Logout" id="Logout1">
</form>
</div>
<div id="wb_Form1" style="position:absolute;left:19px;top:197px;width:340px;height:163px;z-index:9;">
<form name="Form1" method="post" action="mailto:yourname@yourdomain.com" enctype="multipart/form-data" id="Form1">
<a id="Button1" href="./view-bnba.php" style="position:absolute;left:183px;top:123px;width:107px;height:21px;z-index:0;">View</a>
...
<div id="wb_ResponsiveMenu1" style="position:absolute;left:11px;top:90px;width:933px;height:63px;z-index:10;">
...
<div id="wb_LoginName1" style="position:absolute;left:606px;top:17px;width:338px;height:36px;text-align:center;z-index:11;">
...
?></span></div>
<div id="wb_Image9" style="position:absolute;left:429px;top:26px;width:55px;height:48px;z-index:12;">
<img src="images/Picture4 (1).png" id="Image9" alt=""></div>
<div id="wb_Image8" style="position:absolute;left:369px;top:26px;width:60px;height:48px;z-index:13;">
<img src="images/Kemensos.png" id="Image8" alt=""></div>
<div id="wb_FontAwesomeIcon1" style="position:absolute;left:537px;top:26px;width:69px;height:48px;text-align:center;z-index:14;">
