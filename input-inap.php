...
$(document).ready(function()
{
   ...
   $("#FileUpload8 :file").on('change', function()
   {
      var input = $(this).parents('.input-group').find(':text');
      input.val($(this).val());
   });
...
<body>
<div id="container">
<div id="wb_Image1" style="position:absolute;left:11px;top:17px;width:348px;height:66px;z-index:103;">
<img src="images/logo e ipwl1.png" id="Image1" alt=""></div>

<div id="wb_Text3" style="position:absolute;left:11px;top:161px;width:399px;height:21px;z-index:105;">
<p style="font-size:19px;line-height:21px;font-weight:bold;color:#000000;"><span style="color:#000000;">INPUT LAPORAN KEUANGAN RAWAT INAP</span></p></div>
<div id="wb_Logout1" style="position:absolute;left:848px;top:59px;width:94px;height:22px;text-align:center;z-index:106;">
<form name="logoutform" method="post" action="<?php echo basename(__FILE__); ?>" id="logoutform">
<input type="hidden" name="form_name" value="logoutform">
<input type="submit" name="logout" value="Logout" id="Logout1">
</form>
</div>
<form name="Tabs1" method="post" action="mailto:yourname@yourdomain.com" enctype="multipart/form-data" id="Tabs1" style="position:absolute;left:11px;top:206px;width:923px;height:563px;z-index:107;">
<ul>
...
<select name="Combobox1" size="1" id="Combobox9" style="position:absolute;left:247px;top:17px;width:109px;height:28px;z-index:38;">
<option value="Tahap I">Tahap I</option>
<option value="Tahap II">Tahap II</option>
</select>
<label for="" id="Label19" style="position:absolute;left:6px;top:56px;width:130px;height:16px;line-height:16px;z-index:39;">Komponen Bantuan</label>
<select name="Combobox1" size="1" id="Combobox10" style="position:absolute;left:144px;top:54px;width:333px;height:28px;z-index:40;">
<option value="Permakanan">Permakanan</option>
<option value="Snack">Snack</option>
<option value="Pemeliharaan Kesehatan & Kebersihan">Pemeliharaan Kesehatan & Kebersihan</option>
<option value="Pakaian Seragam">Pakaian Seragam</option>
<option value="Perlengkapan Tidur">Perlengkapan Tidur</option>
<option value="Family Dialog (Kuota / Pulsa KPN)">Family Dialog (Kuota / Pulsa KPN)</option>
<option value="Family Dialog (Kuota / Pulsa Konselor)">Family Dialog (Kuota / Pulsa Konselor)</option>
...
<option value="Bimbingan Kreatifitas">Bimbingan Kreatifitas</option>
<option value="Pemulangan">Pemulangan</option>
<option value="ATK, Pengadaan Materi, dan Pelaporan">ATK, Pengadaan Materi, dan Pelaporan</option>
<option value="Flashdisk (Case Record)">Flashdisk (Case Record)</option>
</select>
<label for="" id="Label1" style="position:absolute;left:6px;top:96px;width:60px;height:16px;line-height:16px;z-index:41;">Bulan 1</label>
<label for="" id="Label2" style="position:absolute;left:6px;top:133px;width:60px;height:16px;line-height:16px;z-index:42;">Bulan 2</label>
<input type="text" id="Editbox16" style="position:absolute;left:74px;top:95px;width:272px;height:16px;z-index:43;" name="Editbox16" value="" spellcheck="false">
<input type="text" id="Editbox17" style="position:absolute;left:74px;top:132px;width:272px;height:16px;z-index:44;" name="Editbox16" value="" spellcheck="false">
<label for="" id="Label20" style="position:absolute;left:6px;top:167px;width:60px;height:16px;line-height:16px;z-index:45;">Bulan 3</label>
<input type="text" id="Editbox18" style="position:absolute;left:74px;top:166px;width:272px;height:16px;z-index:46;" name="Editbox16" value="" spellcheck="false">
<label for="" id="Label21" style="position:absolute;left:6px;top:204px;width:60px;height:16px;line-height:16px;z-index:47;">Bulan 4</label>
<input type="text" id="Editbox19" style="position:absolute;left:74px;top:203px;width:272px;height:16px;z-index:48;" name="Editbox16" value="" spellcheck="false">
<div id="FileUpload1" class="input-group" style="position:absolute;left:381px;top:95px;width:154px;height:26px;z-index:49;">
...
<div id="FileUpload2" class="input-group" style="position:absolute;left:381px;top:132px;width:154px;height:26px;z-index:50;">
<input class="form-control" type="text" readonly="">
<label class="input-group-btn">
<input type="file" name="FileUpload1" id="FileUpload2-file" style="display:none;"><span class="btn">Upload Bukti Keuangan</span>
</label>
</div>
<div id="FileUpload3" class="input-group" style="position:absolute;left:381px;top:166px;width:154px;height:26px;z-index:51;">
<input class="form-control" type="text" readonly="">
<label class="input-group-btn">
<input type="file" name="FileUpload1" id="FileUpload3-file" style="display:none;"><span class="btn">Upload Bukti Keuangan</span>
</label>
</div>
<div id="FileUpload4" class="input-group" style="position:absolute;left:381px;top:203px;width:154px;height:26px;z-index:52;">
<input class="form-control" type="text" readonly="">
<label class="input-group-btn">
<input type="file" name="FileUpload1" id="FileUpload4-file" style="display:none;"><span class="btn">Upload Bukti Keuangan</span>
</label>
</div>
<div id="FileUpload5" class="input-group" style="position:absolute;left:547px;top:95px;width:141px;height:26px;z-index:53;">
<input class="form-control" type="text" readonly="">
<label class="input-group-btn">
<input type="file" name="FileUpload1" id="FileUpload5-file" style="display:none;"><span class="btn">Upload Bukti Dukung</span>
</label>
</div>
<div id="FileUpload6" class="input-group" style="position:absolute;left:547px;top:132px;width:141px;height:26px;z-index:54;">
<input class="form-control" type="text" readonly="">
<label class="input-group-btn">
<input type="file" name="FileUpload1" id="FileUpload6-file" style="display:none;"><span class="btn">Upload Bukti Dukung</span>
</label>
</div>
<div id="FileUpload7" class="input-group" style="position:absolute;left:547px;top:166px;width:141px;height:26px;z-index:55;">
<input class="form-control" type="text" readonly="">
<label class="input-group-btn">
<input type="file" name="FileUpload1" id="FileUpload7-file" style="display:none;"><span class="btn">Upload Bukti Dukung</span>
</label>
</div>
<div id="FileUpload8" class="input-group" style="position:absolute;left:547px;top:203px;width:141px;height:26px;z-index:56;">
<input class="form-control" type="text" readonly="">
<label class="input-group-btn">
<input type="file" name="FileUpload1" id="FileUpload8-file" style="display:none;"><span class="btn">Upload Bukti Dukung</span>
</label>
</div>
<input type="submit" id="Button2" onclick="document.getElementById('Combobox10').reset();document.getElementById('Editbox16').reset();document.getElementById('Editbox17').reset();document.getElementById('Editbox18').reset();document.getElementById('Editbox19').reset();return false;" name="Simpan Data" value="Simpan Data" style="position:absolute;left:761px;top:476px;width:144px;height:37px;z-index:57;">
</div>
<div style="height:539px;" id="tabs1-page-2">
<label for="" id="Label5" style="position:absolute;left:9px;top:21px;width:60px;height:16px;line-height:16px;z-index:58;">Tahun</label>
<select name="Combobox1" size="1" id="Combobox6" style="position:absolute;left:77px;top:19px;width:109px;height:28px;z-index:59;">
<option value="2020">2020</option>
<option value="2021">2021</option>
<option value="2022">2022</option>
<option value="2023">2023</option>
</select>
<label for="" id="Label7" style="position:absolute;left:193px;top:21px;width:60px;height:16px;line-height:16px;z-index:60;">Periode</label>
<select name="Combobox1" size="1" id="Combobox7" style="position:absolute;left:250px;top:19px;width:109px;height:28px;z-index:61;">
<option value="Tahap I">Tahap I</option>
<option value="Tahap II">Tahap II</option>
</select>
<label for="" id="Label11" style="position:absolute;left:9px;top:58px;width:130px;height:16px;line-height:16px;z-index:62;">Komponen Bantuan</label>
<select name="Combobox1" size="1" id="Combobox11" style="position:absolute;left:147px;top:56px;width:333px;height:28px;z-index:63;">
<option value="Permakanan">Permakanan</option>
<option value="Snack">Snack</option>
<option value="Pemeliharaan Kesehatan & Kebersihan">Pemeliharaan Kesehatan & Kebersihan</option>
<option value="Pakaian Seragam">Pakaian Seragam</option>
...
<label for="" id="Label12" style="position:absolute;left:9px;top:95px;width:130px;height:16px;line-height:16px;z-index:64;">Jenis Tanda Bukti</label>
<select name="Combobox1" size="1" id="Combobox12" style="position:absolute;left:147px;top:93px;width:333px;height:28px;z-index:65;">
...
<select name="Combobox1" size="1" id="Combobox13" style="position:absolute;left:147px;top:128px;width:48px;height:28px;z-index:66;">
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
<option value="4">4</option>
</select>
<label for="" id="Label22" style="position:absolute;left:9px;top:130px;width:156px;height:16px;line-height:16px;z-index:67;">Bulan Ke</label>
<label for="" id="Label23" style="position:absolute;left:9px;top:170px;width:130px;height:16px;line-height:16px;z-index:68;">Nomor Tanda Bukti</label>
<input type="text" id="Editbox20" style="position:absolute;left:147px;top:170px;width:112px;height:16px;z-index:69;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox21" style="position:absolute;left:147px;top:201px;width:112px;height:16px;z-index:70;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox22" style="position:absolute;left:147px;top:233px;width:112px;height:16px;z-index:71;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox23" style="position:absolute;left:147px;top:265px;width:112px;height:16px;z-index:72;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox24" style="position:absolute;left:147px;top:297px;width:112px;height:16px;z-index:73;" name="Editbox1" value="" spellcheck="false">
<label for="" id="Label24" style="position:absolute;left:271px;top:169px;width:49px;height:16px;line-height:16px;z-index:74;">Tanggal</label>
<input type="text" id="Editbox25" style="position:absolute;left:325px;top:169px;width:29px;height:16px;z-index:75;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox26" style="position:absolute;left:325px;top:200px;width:29px;height:16px;z-index:76;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox27" style="position:absolute;left:325px;top:232px;width:29px;height:16px;z-index:77;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox28" style="position:absolute;left:325px;top:264px;width:29px;height:16px;z-index:78;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox29" style="position:absolute;left:325px;top:296px;width:29px;height:16px;z-index:79;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox30" style="position:absolute;left:370px;top:296px;width:29px;height:16px;z-index:80;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox31" style="position:absolute;left:370px;top:264px;width:29px;height:16px;z-index:81;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox32" style="position:absolute;left:370px;top:232px;width:29px;height:16px;z-index:82;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox33" style="position:absolute;left:370px;top:200px;width:29px;height:16px;z-index:83;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox34" style="position:absolute;left:370px;top:169px;width:29px;height:16px;z-index:84;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox35" style="position:absolute;left:416px;top:169px;width:74px;height:16px;z-index:85;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox36" style="position:absolute;left:416px;top:200px;width:74px;height:16px;z-index:86;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox37" style="position:absolute;left:416px;top:232px;width:74px;height:16px;z-index:87;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox38" style="position:absolute;left:416px;top:264px;width:74px;height:16px;z-index:88;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox39" style="position:absolute;left:416px;top:296px;width:74px;height:16px;z-index:89;" name="Editbox1" value="" spellcheck="false">
<label for="" id="Label25" style="position:absolute;left:500px;top:171px;width:82px;height:16px;line-height:16px;z-index:90;">Nama Vendor</label>
<input type="text" id="Editbox40" style="position:absolute;left:590px;top:170px;width:142px;height:16px;z-index:91;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox41" style="position:absolute;left:590px;top:201px;width:142px;height:16px;z-index:92;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox42" style="position:absolute;left:590px;top:233px;width:142px;height:16px;z-index:93;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox43" style="position:absolute;left:590px;top:265px;width:142px;height:16px;z-index:94;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox44" style="position:absolute;left:590px;top:297px;width:142px;height:16px;z-index:95;" name="Editbox1" value="" spellcheck="false">
<label for="" id="Label26" style="position:absolute;left:742px;top:171px;width:82px;height:16px;line-height:16px;z-index:96;">Nominal</label>
<input type="text" id="Editbox45" style="position:absolute;left:798px;top:170px;width:104px;height:16px;z-index:97;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox46" style="position:absolute;left:798px;top:201px;width:104px;height:16px;z-index:98;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox47" style="position:absolute;left:798px;top:233px;width:104px;height:16px;z-index:99;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox48" style="position:absolute;left:798px;top:265px;width:104px;height:16px;z-index:100;" name="Editbox1" value="" spellcheck="false">
<input type="text" id="Editbox49" style="position:absolute;left:798px;top:297px;width:104px;height:16px;z-index:101;" name="Editbox1" value="" spellcheck="false">
<input type="submit" id="Button3" name="Simpan Data" value="Simpan Data" style="position:absolute;left:760px;top:475px;width:144px;height:37px;z-index:102;">
</div>
</form>

<div id="wb_ResponsiveMenu1" style="position:absolute;left:11px;top:90px;width:933px;height:63px;z-index:108;">
...
<div id="wb_LoginName1" style="position:absolute;left:606px;top:17px;width:338px;height:36px;text-align:center;z-index:109;">
...
?></span></div>
<div id="wb_Image9" style="position:absolute;left:429px;top:26px;width:55px;height:48px;z-index:110;">
<img src="images/Picture4 (1).png" id="Image9" alt=""></div>
<div id="wb_Image8" style="position:absolute;left:369px;top:26px;width:60px;height:48px;z-index:111;">
<img src="images/Kemensos.png" id="Image8" alt=""></div>
<div id="wb_FontAwesomeIcon1" style="position:absolute;left:537px;top:26px;width:69px;height:48px;text-align:center;z-index:112;">
