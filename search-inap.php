...
<link href="search-inap.css" rel="stylesheet">
</head>
<body>
<div id="container">
<div id="wb_Image1" style="position:absolute;left:11px;top:17px;width:348px;height:66px;z-index:5;">
<img src="images/logo e ipwl1.png" id="Image1" alt=""></div>

<div id="wb_Logout1" style="position:absolute;left:848px;top:59px;width:94px;height:22px;text-align:center;z-index:7;">
<form name="logoutform" method="post" action="<?php echo basename(__FILE__); ?>" id="logoutform">
<input type="hidden" name="form_name" value="logoutform">
<input type="submit" name="logout" value="Logout" id="Logout1">
</form>
</div>
<div id="wb_Form1" style="position:absolute;left:19px;top:197px;width:340px;height:163px;z-index:8;">
<form name="Form1" method="post" action="mailto:yourname@yourdomain.com" enctype="multipart/form-data" id="Form1">
<a id="Button1" href="./View-Inap.php" style="position:absolute;left:183px;top:123px;width:107px;height:21px;z-index:0;">View</a>
<select name="Combobox1" size="1" id="Combobox1" style="position:absolute;left:8px;top:37px;width:284px;height:28px;z-index:1;">
...
<div id="wb_Text4" style="position:absolute;left:8px;top:15px;width:218px;height:17px;z-index:2;">
<p style="font-size:15px;line-height:16.5px;color:#000000;"><span style="color:#000000;">PILIH NAMA IPWL</span></p></div>
<div id="wb_Text1" style="position:absolute;left:183px;top:73px;width:109px;height:17px;z-index:3;">
<p style="font-size:15px;line-height:16.5px;color:#000000;"><span style="color:#000000;">TAHUN</span></p></div>
<select name="Combobox1" size="1" id="Combobox2" style="position:absolute;left:183px;top:90px;width:109px;height:28px;z-index:4;">
...
<div id="wb_Text2" style="position:absolute;left:27px;top:270px;width:109px;height:17px;z-index:9;">
<p style="font-size:15px;line-height:16.5px;color:#000000;"><span style="color:#000000;">PERIODE</span></p></div>
<select name="Combobox1" size="1" id="Combobox3" style="position:absolute;left:27px;top:287px;width:109px;height:28px;z-index:10;">
...
<div id="wb_Text3" style="position:absolute;left:19px;top:163px;width:393px;height:18px;z-index:11;">
<p style="font-size:16px;line-height:18px;font-weight:bold;color:#000000;"><span style="color:#000000;">SEARCH LAPORAN KEUANGAN RAWAT INAP</span></p></div>
<div id="wb_ResponsiveMenu1" style="position:absolute;left:11px;top:90px;width:933px;height:63px;z-index:12;">
...
<div id="wb_LoginName1" style="position:absolute;left:606px;top:17px;width:338px;height:36px;text-align:center;z-index:13;">
...
?></span></div>
<div id="wb_Image9" style="position:absolute;left:429px;top:26px;width:55px;height:48px;z-index:14;">
<img src="images/Picture4 (1).png" id="Image9" alt=""></div>
<div id="wb_Image8" style="position:absolute;left:369px;top:26px;width:60px;height:48px;z-index:15;">
<img src="images/Kemensos.png" id="Image8" alt=""></div>
<div id="wb_FontAwesomeIcon1" style="position:absolute;left:537px;top:26px;width:69px;height:48px;text-align:center;z-index:16;">
