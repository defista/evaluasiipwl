...
<link href="kegiatan-ranap.css" rel="stylesheet">
...
<body>
<div id="container">
<div id="wb_Image1" style="position:absolute;left:11px;top:17px;width:348px;height:66px;z-index:23;">
...
<div id="wb_Text3" style="position:absolute;left:21px;top:159px;width:472px;height:20px;z-index:26;">
<p style="font-size:17px;line-height:20.5px;font-weight:bold;color:#000000;"><span style="color:#000000;">Input Pelaksanaan Kegiatan Rehabilitasi Inap</span></p></div>
<div id="wb_Form1" style="position:absolute;left:18px;top:185px;width:580px;height:598px;z-index:27;">
...
<option value="Penerimaan Awal">Penerimaan Awal</option>
<option value="Assesmen">Assesmen</option>
<option value="Konseling Individu">Konseling Individu</option>
<option value="Terapi Kelompok">Terapi Kelompok</option>
<option value="Konferensi Kasus">Konferensi Kasus</option>
<option value="Terapi Psikososial">Terapi Psikososial</option>
<option value="Home Visit (Family Dialogue)">Home Visit (Family Dialogue)</option>
<option value="Family Support / Parenting Skill">Family Support / Parenting Skill</option>
...
<input type="file" name="Upload Foto" id="FileUpload1-file" style="display:none;"><span class="btn">Upload Foto Kegiatan</span>
</label>
</div>
<label for="" id="Label11" style="position:absolute;left:110px;top:11px;width:35px;height:16px;line-height:16px;z-index:22;">Bulan</label>
</form>
</div>
