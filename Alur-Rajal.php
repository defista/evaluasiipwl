...
<link href="Alur-Rajal.css" rel="stylesheet">
...
<body>
<div id="container">
<div id="wb_Image1" style="position:absolute;left:11px;top:17px;width:348px;height:66px;z-index:13;">
<img src="images/logo e ipwl1.png" id="Image1" alt=""></div>

<div id="wb_Logout1" style="position:absolute;left:848px;top:59px;width:94px;height:22px;text-align:center;z-index:15;">
<form name="logoutform" method="post" action="<?php echo basename(__FILE__); ?>" id="logoutform">
<input type="hidden" name="form_name" value="logoutform">
<input type="submit" name="logout" value="Logout" id="Logout1">
</form>
</div>
<div id="wb_Text3" style="position:absolute;left:19px;top:157px;width:358px;height:20px;z-index:16;">
<p style="font-size:17px;line-height:20.5px;font-weight:bold;color:#000000;"><span style="color:#000000;">Input Alur Pelayanan</span></p></div>
<div id="wb_Form1" style="position:absolute;left:19px;top:188px;width:580px;height:543px;z-index:17;">
<form name="uploadform" method="post" action="<?php echo basename(__FILE__);  ?>" enctype="multipart/form-data" id="Form1">
<label for="" id="Label4" style="position:absolute;left:1px;top:19px;width:45px;height:20px;line-height:20px;z-index:0;">Tahap </label>
<label for="" id="Label6" style="position:absolute;left:1px;top:109px;width:123px;height:16px;line-height:16px;z-index:1;">Petugas Pelaksana</label>
<label for="" id="Label7" style="position:absolute;left:321px;top:55px;width:169px;height:16px;line-height:16px;z-index:2;">Kategori Kegiatan</label>
<label for="" id="Label8" style="position:absolute;left:1px;top:55px;width:169px;height:16px;line-height:16px;z-index:3;">Nama Kegiatan</label>
<input type="text" id="Editbox2" style="position:absolute;left:5px;top:79px;width:227px;height:18px;z-index:4;" name="Editbox1" value="" spellcheck="false">
<label for="" id="Label9" style="position:absolute;left:1px;top:165px;width:169px;height:16px;line-height:16px;z-index:5;">Uraian Kegiatan</label>
<label for="" id="Label10" style="position:absolute;left:1px;top:331px;width:169px;height:16px;line-height:16px;z-index:6;">Proses Kegiatan</label>
<a id="Button1" href="./Input-Alur.php" style="position:absolute;left:447px;top:505px;width:113px;height:26px;z-index:7;">Submit</a>
<textarea name="TextArea1" id="TextArea1" style="position:absolute;left:5px;top:190px;width:547px;height:128px;z-index:8;" rows="8" cols="66" spellcheck="false"></textarea>
<textarea name="TextArea1" id="TextArea2" style="position:absolute;left:5px;top:356px;width:547px;height:128px;z-index:9;" rows="8" cols="66" spellcheck="false"></textarea>
<select name="Combobox2" size="1" id="Combobox1" style="position:absolute;left:325px;top:79px;width:237px;height:28px;z-index:10;">
<option value="Akses">Akses</option>
<option value="Intake & Engagement">Intake & Engagement</option>
<option value="Asesmen Komperhensif">Asesmen Komperhensif</option>
<option value="Rencana Intervensi">Rencana Intervensi</option>
<option value="Intervensi">Intervensi</option>
<option value="Supervisi">Supervisi</option>
<option value="Monitoring dan Evaluasi">Monitoring dan Evaluasi</option>
<option value="Pasca Layanan & Terminasi">Pasca Layanan & Terminasi</option>
</select>
<div id="wb_Spinner1" style="position:absolute;left:54px;top:19px;width:55px;height:28px;z-index:11;">
<input type="text" id="Spinner1" style="width:26px;height:20px;line-height:20px;" name="Spinner1" value="1"></div>
<select name="Combobox2" size="1" id="Combobox3" style="position:absolute;left:5px;top:133px;width:237px;height:28px;z-index:12;">
<option value="Staff Penerimaan">Staff Penerimaan</option>
<option value="Petugas Assesment">Petugas Assesment</option>
<option value="Pekerja Sosial">Pekerja Sosial</option>
<option value="Konselor Adiksi">Konselor Adiksi</option>
<option value="Pembimbing Spiritual">Pembimbing Spiritual</option>
...
<div id="wb_LoginName1" style="position:absolute;left:606px;top:17px;width:338px;height:36px;text-align:center;z-index:19;">
...
?></span></div>
<div id="wb_Image9" style="position:absolute;left:429px;top:26px;width:55px;height:48px;z-index:20;">
<img src="images/Picture4 (1).png" id="Image9" alt=""></div>
<div id="wb_Image8" style="position:absolute;left:369px;top:26px;width:60px;height:48px;z-index:21;">
<img src="images/Kemensos.png" id="Image8" alt=""></div>
<div id="wb_FontAwesomeIcon1" style="position:absolute;left:537px;top:26px;width:69px;height:48px;text-align:center;z-index:22;">
